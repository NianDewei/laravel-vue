...
@section('content')
    <div class="container">
        <h1 class="text-center mt-4 fs-2"> Editar Establecimiento</h1>
        <div class="mt-3 row justify-content-center">
            <form id="form-establecimiento" action="{{ route('establecimiento.update',['establecimiento'=> $establecimiento->id]) }}"
                ...
                <fieldset class="border p-4 mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="categoria_id" id="categoria"
                            ...
                            @forelse ($categorias as $key => $categoria)
                                <option {{ $establecimiento->categoria_id == $key ? 'selected' : '' }}
                                    value="{{ $key }}">
                                    {{ $categoria }}</option>
                            @empty
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" name="imagen_principal_actual" value="{{ $establecimiento->imagen_principal}}">
                        ...
                        <img class="img-thumbnail mt-2" src="{{ asset("storage/$establecimiento->imagen_principal") }}"
                ...
                <fieldset class="border p-4 mb-3">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input id="b-direccion" type="text" class="form-control" placeholder="Calle / Avenida # , Ciudad o Region">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="direccion" type="text" class="form-control @error('direccion') is-invalid @enderror"
                            placeholder="Ingrese el dirección" name="direccion" value="{{ $establecimiento->direccion }}">
                        @error('direccion')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="cuadra" type="text" class="form-control @error('cuadra') is-invalid @enderror"
                            placeholder="Ingrese la cuadra" name="cuadra" value="{{ $establecimiento->cuadra }}">
                        @error('cuadra')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                            </div>
                ...
                <fieldset class="border p-4 mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror"
                            placeholder="Télefono del Establecimiento" name="telefono" value="{{ $establecimiento->telefono }}">
                        @error('telefono')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea id="descripcion" type="text" class="form-control @error('descripcion') is-invalid @enderror"
                            placeholder="Télefono del Establecimiento" name="descripcion"> {{ $establecimiento->descripcion }}
                                        </textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                ...
                <fieldset class="border p-4 mb-3">
                    ...
                    @forelse ($galeria as $imagen)
                        <input type="hidden" class="galeria" value="{{ $imagen}}">
                    @empty
                ...
                <input type="submit" class="btn btn-primary mt-3 d-block" value="Actualizar">
